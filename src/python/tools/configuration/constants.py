...
class PathConstants:
    ...
    node_partitions_file: str = "node_partitions.bin"
    partition_score_file: str = "partition_score.bin"
    partition_offsets_bin_file: str = "partition_offsets.bin"

    node_partitions_path: str = nodes_directory + node_partitions_file
    partition_score_path: str = edges_directory + partition_score_file
    train_partition_offsets_bin_path: str = edges_directory + training_file_prefix + partition_offsets_bin_file
