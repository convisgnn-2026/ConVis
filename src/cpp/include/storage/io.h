...
// HiCab-CLO artifacts. Returns tuple<node_partitions, partition_offsets, partition_score>.
// Each may be nullptr if the corresponding file is absent — they're only required when
// CUSTOM node_partition_ordering is selected.
