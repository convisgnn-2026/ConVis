...
const string node_partitions_file = "node_partitions";
const string partition_score_file = "partition_score";
const string partition_offsets_bin_file = "partition_offsets";
